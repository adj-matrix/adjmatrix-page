...
>
> 很多时候你会发现：“这行代码在我电脑上跑得好好的，怎么在你那就不行了？”这通常是因为运行环境（依赖库、系统配置）不一致导致的。这时，**[Docker](https://www.docker.com/)** 便登场了。如果说 Git 是代码的“时光机”，那 Docker 就是环境的“集装箱”。它能将你的代码连同整个运行环境打包，确保在任何地方运行的结果都完全一致。
>
